  ...
  return (
    ...
    >
      <div className="w-[25%] h-full flex justify-center items-center">
        <div className="text-center font-robotoCondensed italic bg-customBlack-700 p-6 -rotate-90 text-white text-[50px] font-normal ">
          CERTIFICATES
        </div>
      </div>
        ...
        <div className="w-full py-28 h-fit left-0 top-0 relative flex-col justify-center items-center gap-[41px] inline-flex">
          <div className="w- justify-center items-center gap-[406px] inline-flex">
            <div className="flex-col justify-start items-start gap-1 inline-flex">
              <div className="text-zinc-900 text-[50px] font-bold font-['Roboto']">
                CERTIFICATE 1
              </div>
              <div className="text-zinc-900 text-[25px] font-normal font-['Roboto']">
                DESCRIPTION OF CERIFICATE
              </div>
              <div className="text-zinc-900 text-lg font-light font-['Roboto']">
                DATE OF COMPLETION: 10-10-2023
              </div>
            </div>
            <div className="h-[50px] justify-center items-center gap-5 flex">
              <FaEye className="w-[50px] h-[50px]" />
              <IoMdDownload className="w-[50px] h-[50px]" />
            </div>
          </div>
